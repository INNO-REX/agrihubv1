defmodule AgrihubWeb.CoreComponents do
  use Phoenix.Component
  alias Phoenix.LiveView.JS
  import AgrihubWeb.Gettext
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-4 right-4 z-[100] w-80 sm:w-96 rounded-lg p-4 shadow-md pointer-events-auto",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AgrihubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AgrihubWeb.Gettext, "errors", msg, opts)
    end
  end
